...
--Ammo_Pallet_Contents({user_name = _(""), clsid = "Herc_Ammo__missiles", contents = "", count = ,  mass = , wstype = {}}) --addname
---------------------------------------------------------------------------------------	
function Ammo_Pallet_Contents(main)
	local data = main
	declare_loadout({
...
Cargo_Contents({user_name = _("HEMTT TFFT [34400lb]"), clsid = "Herc_HEMTT_FFT", mass = 15634, model = "hemtt_fire", CargoIcon = "Herc_Mil_Vehicle.png"})--Hemtt GPU
...
Cargo_Contents({user_name = _("MBT M1A2 [67600lb]"), clsid = "Herc_ART_M1A2", mass = 15782, model = "m-1", CargoIcon = "Herc_Mil_Vehicle.png"}) --abrams
Cargo_Contents({user_name = _("Pallate M1A2 [67600lb]"), clsid = "Herc_ART_M1A2_PALLATE", mass = 15782, model = "Hercules_Container_Parachute", CargoIcon = "Herc_Container.png"}) --abrams
